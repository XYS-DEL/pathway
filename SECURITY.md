...
团队和社区非常重视行屿中的安全问题。感谢您为负责任地披露您的发现所做的努力。

The team and community take security issues in Pathway seriously. We appreciate your efforts to responsibly disclose your findings. 

如果您发现了任何安全漏洞，请给 3322794490@qq.com 发送邮件。邮件标题为 `[SECURITY][行屿] xxxxx`, 内容格式如下所示：

To report a security issue, email to 3322794490@qq.com. The mail title should be `[SECURITY][Pathway] xxxxx` and content are as below:
```
...
<!-- 请在上方描述出问题的行屿版本及使用的系统版本，然后删除该注释。 -->
<!-- Please describe version of Pathway and used OS above, then delete this comment. -->
